...
<head>
    ...
    <script>
        var hdjs = {
            ...
            'removeImage': "<?php echo u('system/component/removeImage')?>"
        };
    </script>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo u('admin.cate.out')?>">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <ul class="list-group menus collapse in" id="collapseExample">
                    <a href="<?php echo u('admin.cate.index')?>" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample2">
                    <a href="<?php echo u('admin.tag.index')?>" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="<?php echo u('admin.article.index')?>" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章列表
                    </a>
                    <a href="<?php echo u('admin.article.recycle')?>" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        回收站
                    </a>
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="<?php echo u('admin.webset.index')?>" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        站点配置
                    </a>
