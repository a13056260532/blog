...
<head>
    ...
    <script>
        var hdjs = {
            //框架目录
            'base': '/resource/hdjs',
            'uploader': "http://localhost/new_blog/index.php?s=system/component/uploader",
            'filesLists': "http://localhost/new_blog/index.php?s=system/component/filesLists",
            'removeImage': "http://localhost/new_blog/index.php?s=system/component/removeImage"
        };
    </script>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">王安琪博客网后台管理系统</a>
                </h4>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="http://localhost/new_blog/index.php?s=admin/cate/out">退出</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus">
                ...
                <ul class="list-group menus collapse in" id="collapseExample">
                    <a href="http://localhost/new_blog/index.php?s=admin/cate/index" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample2">
                    <a href="http://localhost/new_blog/index.php?s=admin/tag/index" class="list-group-item">
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/new_blog/index.php?s=admin/article/index" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        文章列表
                    </a>
                    <a href="http://localhost/new_blog/index.php?s=admin/article/recycle" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        回收站
                    </a>
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/new_blog/index.php?s=admin/link/index" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        友链列表
                    </a>
                ...
                <ul class="list-group menus collapse in" id="collapseExample3">
                    <a href="http://localhost/new_blog/index.php?s=admin/webset/index" class="list-group-item">
                        <i class="fa fa-wrench" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        站点配置
                    </a>
