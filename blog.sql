...
-- Schema blog_edu
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `blog_edu` DEFAULT CHARACTER SET utf8 ;
USE `blog_edu` ;

-- -----------------------------------------------------
-- Table `blog_edu`.`blog_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_user` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_user` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_category` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_category` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_article`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_article` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_article` (
  ...
  `keywords` VARCHAR(150) NOT NULL DEFAULT '' COMMENT '文章关键字',
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_tag` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_tag` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_article_tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_article_tag` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_article_tag` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_webset`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_webset` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_webset` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_link`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_link` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_link` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_comment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_comment` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_comment` (
...
-- -----------------------------------------------------
-- Table `blog_edu`.`blog_article_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `blog_edu`.`blog_article_data` ;

CREATE TABLE IF NOT EXISTS `blog_edu`.`blog_article_data` (
